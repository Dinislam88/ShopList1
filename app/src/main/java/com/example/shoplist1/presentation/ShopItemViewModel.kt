...
import com.example.shoplist1.domain.AddShopItemUseCase
import com.example.shoplist1.domain.EditShopItemUseCase
import com.example.shoplist1.domain.GetShopItemUseCase
...
class ShopItemViewModel: ViewModel() {
    ...
    fun restErrorInputName() {
        _errorInputName.value = false
    }

    fun restErrorInputCount() {
